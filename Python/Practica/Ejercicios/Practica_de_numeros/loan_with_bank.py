...
class Bbva(LoanSimulator):
    def __init__(self, loan_det = None, total_years_payment=30, house_price = 300000):
        self._monthly_payment = 2.65j
        loan_det = loan_det + self._monthly_payment
        super().__init__(self._loan_det, total_years_payment, house_price)
...
if __name__ == "__main__":
    ...
    loan_sim = Bbva(loan_det, loan_years, house_price)
